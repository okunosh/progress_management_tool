    ...
    <body>
        <div class="container">
            ...
            <div class="goals">
                ...
                <!-- Progress Chart -->
                <canvas id="progressChart{{ $short_goal->short_term_goal_id }}" data-goal-id="{{ $short_goal->short_term_goal_id }}" data-progress-rate="{{ number_format($short_goal->progress_rate, 2) }}" data-goal-name="{{ $short_goal->goal_name }}" data-goal-type="short" ></canvas>
                </div>
            @endforeach
        </div>
        <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
